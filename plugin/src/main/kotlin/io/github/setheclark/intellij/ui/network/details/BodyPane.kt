...
private suspend fun openInScratchFile(project: Project, context: ScratchFileContext) {
    ...
    val formattedBody = IntellijUtil.formatText(project, context.body, fileType)
    try {
